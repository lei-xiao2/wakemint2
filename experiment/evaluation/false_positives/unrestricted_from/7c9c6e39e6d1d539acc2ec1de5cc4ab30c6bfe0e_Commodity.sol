...
contract AssetContract is ERC721Tradable, ReentrancyGuard {
    ...
    function setTokenPriceOf(
        string memory _tokenType,
        uint256 _tokenPrice
    ) public onlyOwnerOrProxy returns (uint256) {
    ...
    function burn(
        address _from,
        uint256 _id
    ) public onlyTokenAmountOwned(_from, _id) {
        super.burn(_id);
    }
    ...
    function setPermanentURI(
        uint256 _id,
        string memory _uri
    ) public onlyOwnerOrProxy onlyImpermanentURI(_id) {
