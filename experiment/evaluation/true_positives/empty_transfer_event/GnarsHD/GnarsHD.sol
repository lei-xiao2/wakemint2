...
contract GnarsHD is Owned {
    ...
    function getPartQueryParam(
        ...
        return
            string.concat(
                ...
                folder,
                "/",
                Strings.toString(partIndex),
                ".PNG"
            );
    }

    function getBackgroundQueryParam(
        uint48 backgroundIndex
    ) public view returns (string memory) {
        ...
        return
            string.concat(
                ...
                artwork.ipfsFolder,
                "/BACKGROUND/",
                Strings.toString(backgroundIndex),
                ".PNG"
            );
    }
    ...
    function getPartTrait(
        ...
        function(uint256)
            external
            view
            returns (string memory) getPartDescription
    ) public view returns (string memory) {
        try getPartDescription(partIndex) returns (
    ...
    function tokenURI(uint256 _tokenId) public view returns (string memory) {
        ...
        (string memory attributes, string memory queryString) = getAttributes(
            _tokenId
        );
        return
            string(
