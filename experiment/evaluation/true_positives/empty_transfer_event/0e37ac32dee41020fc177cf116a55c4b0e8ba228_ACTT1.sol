...
contract ACTT1 is ERC721, Ownable {
    ...
    function ownerOf(
        ...
        return
            externalNft(externalNftAddrs[tokenId]).ownerOf(
                externalTokenIds[tokenId]
            );
    }
