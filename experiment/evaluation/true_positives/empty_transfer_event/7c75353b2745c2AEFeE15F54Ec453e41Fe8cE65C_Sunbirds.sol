 ...
 *
 */
contract Sunbirds is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    string internal _baseTokenURI =
        "ipfs://QmTw74Wvi5HjqVS2QRha5N6EVM31B6n32ZyxtpM47jfXaP";
    ...
    Target721 _target = Target721(0x23581767a106ae21c074b2276D25e5C3e136a68b);
    ...
    function bifurcateToken(uint256 tokenId) external {
        address owner = ownerOf(tokenId);
        require(
            owner == _msgSender() || isContractOwner(),
