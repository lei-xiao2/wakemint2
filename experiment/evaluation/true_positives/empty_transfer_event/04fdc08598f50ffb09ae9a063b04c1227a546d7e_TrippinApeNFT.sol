 ...
 *
 */
contract TrippinApeNFT is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    function mintAddress(address[] calldata recipients) external onlyOwner {
