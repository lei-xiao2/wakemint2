...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _safeTransfer(
        ...
        require(
            ...
            "Attempted transfer to non ERC721Receiver implementer!"
        );
    }
...
contract Clockchains is Context, ERC721Enumerable, ERC721Burnable, IERC2309 {
    ...
    string private _baseTokenURI =
        "https://arielbecker.com/Clockchains/token.php";
    string private _contractURI =
        "https://arielbecker.com/Clockchains/contract.php";
    string private _contractJSON =
        '{"name": "Clockchains v1.0","description": "Clockchains are 365 onchain-stored clocks that display the date, time, and lunar phase, according to the tier.","image": "https://arielbecker.com/Clockchains/assets/img/chclocks.png","external_link": "https://arielbecker.com/Clockchains","seller_fee_basis_points": 1000,"fee_recipient": "0xC12Df5F402A8B8BEaea49ed9baD9c95fCcbfE907"}';
    ...
    function MassMint() public virtual {
        ...
        emit ConsecutiveTransfer(
            ...
            364,
            address(0),
            0xC12Df5F402A8B8BEaea49ed9baD9c95fCcbfE907
        );
    }
    ...
    function royaltyInfo(
        uint256 _tokenId,
        uint256 _salePrice
    ) external view returns (address receiver, uint256 royaltiesAmount) {
        require(_tokenId >= 0, "Token ID cannot be less than zero!");
        require(_tokenId < totalSupply(), "Token ID out of bounds!");
        if (_salePrice > 99) {
            // Only makes sense to pay royalties if the sell value is more than 100 wei; otherwise, who cares?
            uint256 valorRoyalties = _salePrice.div(100).mul(
