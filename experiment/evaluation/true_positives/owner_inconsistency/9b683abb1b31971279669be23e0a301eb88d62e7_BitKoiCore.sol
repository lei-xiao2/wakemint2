...
abstract contract BitKoiBreeding is BitKoiOwnership {
    ...
    function _isValidMatingPair(
        ...
        if (
            _parent1.parent1Id == _parent1Id || _parent1.parent2Id == _parent2Id
        ) {
            return false;
        }
        if (
            _parent2.parent1Id == _parent1Id || _parent2.parent2Id == _parent2Id
        ) {
            return false;
        }
    ...
    function breedWith(
        ...
        require(_isValidMatingPair(parent2, _parent2Id, parent1, _parent1Id));
