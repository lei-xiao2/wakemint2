    ...
    IERC721Enumerable
{
    ...
    function _transfer(address from, address to, uint256 tokenId) private {
        ...
        if (from == 0x000000000000000000000000000000000000dEaD)
            revert TransferFromZeroAddressBlocked();
...
contract PSYOPFF6000 is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    ...
    ) ERC721A("PSYOP FF6000 DUCKS", "QUACK") {
    ...
    function mint(uint256 quantity) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            uint256 balanceFreeMint = max_free_per_wallet -
                freeMinted[msg.sender];
            require(
                msg.value >= (price * (quantity - balanceFreeMint)),
                "Not Enough ETH Sent"
            );
    ...
    function burn(uint256 tokenId) public onlyOwner {
        ...
        safeTransferFrom(
            ownerOf(tokenId),
            0x000000000000000000000000000000000000dEaD /*address(0)*/,
            tokenId
        );
    }
    ...
    function setMax_free_per_wallet(
