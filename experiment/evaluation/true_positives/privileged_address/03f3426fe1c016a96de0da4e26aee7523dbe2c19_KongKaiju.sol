...
contract KongKaiju is ERC721Enumerable, Ownable {
    ...
    function isEligiblePrivateSale(
        address _wallet
    ) public view virtual returns (bool) {
        return whitelist[_wallet];
    }

    function isEligibleOGSale(
        address _wallet
    ) public view virtual returns (bool) {
    ...
    function presaleWL(uint _amount, bool _stake) public payable {
        ...
        require(
            whitelist[msg.sender] || OGlist[msg.sender],
        ...
        require(
            minted[msg.sender] + _amount <= MAX_WL_PURCHASE,
            "Max 3 mints for OG and 2 mints for WL per wallet"
        );
    ...
    function mint(uint _amount, bool _stake) public payable whenNotPaused {
        ...
        if (phase == 1) {
            ...
            require(
                Gamma.balanceOf(msg.sender) >= Gammacost,
                "Not enough GAMMA"
            );
        }
