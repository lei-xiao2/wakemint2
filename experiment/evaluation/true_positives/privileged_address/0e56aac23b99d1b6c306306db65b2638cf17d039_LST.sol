...
contract LST is ERC721, Ownable {
    ...
    */
    function mintNFT() public payable {
        ...
        require(
            canMint,
            "LST: You can't mint because don't match requirements"
        );
        require(
            msg.value % price == 0,
            "LST: Amount should be a multiple of minting cost"
        );
        ...
        require(
            purchases <= max_mint,
            "LST: Cannot purchase more than 2 per OG nft"
        );
        uint j = 0;
        for (j = 0; j < amount; j++) {
    ...
    function fixContractDescription(
