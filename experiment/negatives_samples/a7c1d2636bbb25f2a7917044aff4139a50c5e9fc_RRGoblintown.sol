...
contract RRGoblintown is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    string private baseURI =
        "ipfs://Qmf4eM2UiSk5621VnYVVxcVkXqWLsU11kyj1smMQPnS1Jk/";
    ...
    constructor() ERC721A("RR/GOBLINTOWN", "RR/GOBLIN", 100, maxSupply) {}
    ...
    function setLowerMaxSupply(uint256 _newMax) external onlyOwner {
        maxSupply = _newMax;
    }
    ...
    function tokenURI(
        ...
        return
            ...
            string(
                abi.encodePacked(baseURI, "/", (tokenId + 1).toString(), "")
            );
    }
