...
contract LongLost is ERC721, Ownable {
    ...
    bytes32 public whitelistMerkleRoot =
        0x0758ddc53129da410a7d4536b32e8f2f00e4edf3568e11b199fdc384d06a55d3;
    ...
    function remainingAllowListMints(
        address userAddress
    ) public view returns (uint256) {
        return allowListMintAmount - _mintAllowList[userAddress];
    }

    function remainingPublicMints(
        address userAddress
    ) public view returns (uint256) {
    ...
    function withdraw() public onlyOwner {
        ...
        (bool hs, ) = payable(0x086C47A4E99cd41aF68166Fba0ad163546AAA50e).call{
