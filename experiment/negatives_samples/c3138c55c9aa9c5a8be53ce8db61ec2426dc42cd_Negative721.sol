    ...
    IERC721Enumerable
{
    ...
    function contractURI() public view returns (string memory) {
        return
            string(abi.encodePacked(baseURI(), "contract_metadata", ".json"));
    }
...
contract Negative721 is Context, ERC721, Ownable {
    ...
    event Negate(
        address minter,
        uint256 price,
        address contractToNegate,
        uint256 tokenIdToNegate
    );
    ...
    function negate(
        ...
        require(
            !negatedTokens[
                keccak256(abi.encodePacked(contractToNegate, tokenIdToNegate))
            ],
