...
contract BlockbuddiesMetaverse is ERC721A, Ownable {
    ...
    function freeMint() external payable {
        ...
        require(tx.origin == _caller, "No contracts");
        require(
            MAX_PER_TX_FREE >= uint256(_getAux(_caller)) + 1,
