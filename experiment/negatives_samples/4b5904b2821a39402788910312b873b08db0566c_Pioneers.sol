...
contract Pioneers is ERC721 {
    ...
    function tokenURI(
        ...
        string
            memory baseSvg = "<svg viewBox='0 0 800 800' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>"
    ...
    function mint(
        address to
    ) public payable virtual isCorrectPayment canMint isMintingOpen {
    ...
    /// @param to The address to mint to
    function privateMint(address to) public payable virtual onlyOwner {
        uint256 tokenId = uint256(tokenCount);
        unchecked {
            ++tokenCount;
        }
