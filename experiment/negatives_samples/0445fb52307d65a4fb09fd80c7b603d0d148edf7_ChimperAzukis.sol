...
contract ChimperAzukis is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            if (dynamicCost == true) {
                require(
                    msg.value >= needToUpdateCost(supply) * _mintAmount,
                    "Not enough funds"
                );
            }
    ...
    function setmaxMintTX(uint256 _newmaxMintTX) public onlyOwner {
        maxMintTX = _newmaxMintTX;
    }
