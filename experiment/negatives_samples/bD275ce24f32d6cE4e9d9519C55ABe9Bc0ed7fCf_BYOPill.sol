...
contract BYOPill is ERC721Enumerable, Ownable {
    ...
    function mintPill(uint numberOfTokens) public payable {
        ...
        require(
            numberOfTokens <= m_MaxPillPurchase,
            "Can only mint set pills at a time."
        );
        require(
            m_PillPrice.mul(numberOfTokens) <= msg.value,
    ...
    function getPillInfo(
        uint256 tokenId
    ) public view returns (PillInfo memory info) {
