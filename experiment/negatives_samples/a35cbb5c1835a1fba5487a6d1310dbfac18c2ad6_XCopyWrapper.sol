...
contract XCopyWrapper is Context, ERC165, IERC721, IERC721Metadata {
    ...
    constructor(
        ...
        XCopyOriginal[] memory originals_
    ) {
        _name = name_;
        _symbol = symbol_;
    ...
    function wrap(XCopyOriginal toWrap) external {
        ...
        require(
            tokenId < _originals.length,
            "Not in known / configured originals"
        );
    ...
    function unwrap(uint256 tokenId) external {
        require(
            ...
            "ERC721: unwrap caller is not owner nor approved"
        );
        _burn(tokenId);
    ...
    function _transfer(
        ...
        require(
            XCopyWrapper.ownerOf(tokenId) == from,
